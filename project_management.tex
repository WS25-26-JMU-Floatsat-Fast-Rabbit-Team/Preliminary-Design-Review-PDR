...
\begin{center}
    ...
    \begin{ganttchart}[
        ...
        \ganttmilestone{Project Progress Presentation}{13} \\
        \ganttmilestone{Final Review}{16} \\
        \\
...
Requirements for WP2200 and WP2300.}\\
    ...
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Results:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Electrical Interface Requirements}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \hline
\end{tabular}
&
...
\begin{tabular}{|p{.2\columnwidth}||p{.3\columnwidth}|p{.27\columnwidth}||p{.23\columnwidth}|}
    ...
    \hline\hline
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Goals:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Define the overall software architecture for FloatSat}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Establish module boundaries for sensor handling, control loop execution, and communication}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Input:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Electrical and mechanical interface definitions}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Control system requirements and reaction-wheel configuration}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Connections to other WPs:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{Provides architecture constraints for WP 4200 (Post-PDR refinement). Defines driver requirements for WP 4300 (Interface Drivers). Supplies structure for WP 4400 (Telemetry Integration) and WP 4500 (Control Algorithms).}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Tasks:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Define software layers and module interfaces. Specify the timing structure (1–10 ms loop, interrupt handling). Document communication flows and data-handling architecture}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Results:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Clear interaction model between STM32 and ESP32 for later implementation}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Defined module structure for drivers, control loop, telemetry, and state machine}\\
    \hline
\end{tabular}
...
\begin{tabular}{|p{.2\columnwidth}||p{.3\columnwidth}|p{.27\columnwidth}||p{.23\columnwidth}|}
    ...
    \hline\hline
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Goals:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Implement STM32 drivers for all electrical interfaces (IMU, SPI, PWM, motor drivers)}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Ensure reliable communication between STM32 and ESP32 as defined in the architecture}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Input:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Electrical schematics and pin assignments}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Datasheets for IMU, motor drivers, STM32 peripherals, and ESP32 interface}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Connections to other WPs:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{Supplies drivers used in WP 4400 (Telemetry Integration) and WP 4500 (Control Algorithms). Refines interface constraints from WP 4200 (Post-PDR Architectural Refinement). Required for integration testing in WP 6100.}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Tasks:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Implement IMU I2C/SPI driver and data acquisition functions. Implement PWM and commutation control for reaction wheels. Implement SPI protocol between STM32 and ESP32. Verify correct pin mapping and signal behavior on hardware.}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Results:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Verified communication between STM32 and ESP32}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Stable motor-control and sensor-access routines ready for higher-level software}\\
    \hline
\end{tabular}
...
\begin{tabular}{|p{.2\columnwidth}||p{.3\columnwidth}|p{.27\columnwidth}||p{.23\columnwidth}|}
    ...
    \hline\hline
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Goals:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Integrate Wi-Fi telemetry and command handling between ESP32 and the ground station}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Input:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ SPI communication structure and driver interfaces from previous WPs}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Connections to other WPs:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{Provides telemetry and command pathways required for WP 6100 (Subsystem Integration).}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Tasks:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Implement packet handling, transmission, and reception over Wi-Fi and SPI and develop GUI}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Results:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Working communication link between FloatSat and the ground station with a GUI.}\\
...
\begin{tabular}{|p{.2\columnwidth}||p{.3\columnwidth}|p{.27\columnwidth}||p{.23\columnwidth}|}
    ...
    \hline\hline
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Goals:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Implement and tune the PID-based attitude control logic for the reaction-wheel system}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Input:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Control requirements and actuator geometry from previous WPs.}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Connections to other WPs:}} \\
    \multicolumn{4}{|p{.95\columnwidth}|}{Provides the core control loop for WP 5500 (Final Control Validation).}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Tasks:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Develop, test, and integrate the PID control loop into the STM32 software}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Results:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Working attitude-control algorithm integrated into the FloatSat software stack.}\\
    \hline
\end{tabular}
...
\begin{tabular}{|p{.2\columnwidth}||p{.3\columnwidth}|p{.27\columnwidth}||p{.23\columnwidth}|}
    ...
    \hline\hline
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Goals:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Find bugs in STM32 and ESP code}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Input:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Implemented drivers and control algorithms from previous WPs.}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Connections to other WPs:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{Required for WP 6100 (Subsystem Integration).}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Tasks:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Test, debug, and validate software behavior on the actual FloatSat}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Results:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Stable and validated software ready for integration}\\
    \hline
\end{tabular}
&
% --- WP5100 ---
\begin{tabular}{|p{.2\columnwidth}||p{.3\columnwidth}|p{.27\columnwidth}||p{.23\columnwidth}|}
    ...
    \hline\hline
    \textbf{Title} & \multicolumn{2}{p{.40\columnwidth}||}{\textbf{Review of Reaction Wheel Control Approaches}}
    & \textbf{Version:} 1.0\\
    \hline
    \textbf{Responsible} & \multicolumn{2}{l||}{Abdirakhman Onabek}
    & \textbf{Date:} \wpddate\\
    ...
    % ---- GOALS ----
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Goals:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Gain a basic understanding of common reaction wheel control methods.}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Identify which approaches are feasible for FloatSat.}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\

    % ---- INPUT ----
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Input:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Selected papers and reference materials on attitude control.}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Basic FloatSat dynamics and actuator configuration.}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\

    % ---- CONNECTIONS ----
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Connections to other WPs:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{Provides background needed for selecting a suitable control approach in WP 5200.}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\

    % ---- TASKS ----
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Tasks:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Review basic reaction wheel control strategies (e.g. PID, PD).}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Summarize key advantages and limitations.}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\

    % ---- RESULTS ----
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Results:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Simple overview of applicable control methods for FloatSat.}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Recommendation of which approach to evaluate further in WP 5200.}\\
...
\begin{tabular}{|p{.2\columnwidth}||p{.3\columnwidth}|p{.27\columnwidth}||p{.23\columnwidth}|}
    ...
    \hline\hline
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Goals:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Compare candidate control strategies and select the most suitable approach for FloatSat}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Input:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Attitude dynamics model and actuator configuration from earlier WPs}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Connections to other WPs:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{Provides the chosen control approach required for WP 5300 (Control System Architecture).}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Tasks:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Evaluate control options (e.g., PID, PD, or alternative methods) and justify the final selection.}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Results:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Selected baseline control topology with rationale for use in later design stages.}\\
    \hline
\end{tabular}
&
% --- WP5300 ---
\begin{tabular}{|p{.2\columnwidth}||p{.3\columnwidth}|p{.27\columnwidth}||p{.23\columnwidth}|}
    ...
    \hline\hline
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Goals:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Define the overall control-system architecture based on the selected control topology.}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Input:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Selected control method and actuator configuration from WP 5200.}\\

    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Connections to other WPs:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{Provides the control-system framework required for WP 5400 (Control Improvements).}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Tasks:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Specify control-loop structure, required signals, and data flow between modules.}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Results:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Baseline control-system architecture for implementation in later WPs.}\\
...
\begin{tabular}{|p{.2\columnwidth}||p{.3\columnwidth}|p{.27\columnwidth}||p{.23\columnwidth}|}
    ...
    \hline\hline
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Goals:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Improve the control-system design based on PDR comments and identified weaknesses}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Input:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ PDR feedback and the baseline control architecture from WP 5300}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Connections to other WPs:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{Refines the control design prior to WP 5500 (Final Validation)}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Tasks:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Apply design adjustments and update control parameters and architecture as needed}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Results:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Updated control-system design incorporating all PDR recommendations}\\
    \hline
\end{tabular}
&
% --- WP5500 ---
\begin{tabular}{|p{.2\columnwidth}||p{.3\columnwidth}|p{.27\columnwidth}||p{.23\columnwidth}|}
    ...
    \hline\hline
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Goals:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Finalize and validate the complete control-system design on the finalized architecture.}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Input:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Updated control design from WP 5400 and system-level constraints.}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Connections to other WPs:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{Prepares the verified control system for integration in WP 6100.}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Tasks:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Validate controller performance through testing, simulation checks, and parameter refinement.}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{\textbf{Results:}}\\
    \multicolumn{4}{|p{.95\columnwidth}|}{$\bullet$ Fully validated control-system design ready for system integration.}\\
    \hline
\end{tabular}
